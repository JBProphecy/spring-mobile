...
import { handleRegisterAccountResponse, RegisterAccountResponseData, sendRegisterAccountRequest } from "@/api/server/routes/register-account"
import { RegisterAccountRequestBody } from "@/api/server/server-request-body"
import { InternalServerErrorResponseBody, InvalidRequestBodyResponseBody, RegisterAccountResponseBodySuccess } from "@/api/server/server-response-body"
import { EmailValidationResult, NameValidationResult, PasswordValidationResult, RegisterAccountValidationResult } from "@/api/server/server-validation"
import { useState } from "react"
import { Pressable, ScrollView, StyleSheet, Text, TextInput, View } from "react-native"
import { OptionalValidationMessageBlock } from "./validation-nest"
